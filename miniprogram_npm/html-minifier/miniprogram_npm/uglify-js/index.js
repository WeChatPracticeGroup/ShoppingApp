...
__DEFINE__(1679975000842, function(require, module, exports) {
var fs = require("fs");
...
}, function(modId) {var map = {"./domprops.json":1679975000843}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975000843, function(require, module, exports) {
module.exports = [
    "$&",
    "$'",
    "$*",
...
return __REQUIRE__(1679975000842);
})()
