...
__DEFINE__(1679975014017, function(require, module, exports) {
...
return __REQUIRE__(1679975014017);
})()
//miniprogram-npm-outsideDeps=["@babel/runtime/helpers/interopRequireDefault","core-js/modules/es.array.map","@babel/runtime/helpers/toConsumableArray","timm","@jimp/plugin-blit","@jimp/plugin-blur","@jimp/plugin-circle","@jimp/plugin-color","@jimp/plugin-contain","@jimp/plugin-cover","@jimp/plugin-crop","@jimp/plugin-displace","@jimp/plugin-dither","@jimp/plugin-fisheye","@jimp/plugin-flip","@jimp/plugin-gaussian","@jimp/plugin-invert","@jimp/plugin-mask","@jimp/plugin-normalize","@jimp/plugin-print","@jimp/plugin-resize","@jimp/plugin-rotate","@jimp/plugin-scale","@jimp/plugin-shadow","@jimp/plugin-threshold"]
//# sourceMappingURL=index.js.map