...
__DEFINE__(1679975014008, function(require, module, exports) {
...
}, function(modId) {var map = {"./measure-text":1679975014009}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975014009, function(require, module, exports) {
...
return __REQUIRE__(1679975014008);
})()
//miniprogram-npm-outsideDeps=["@babel/runtime/helpers/interopRequireDefault","core-js/modules/es.array.concat","core-js/modules/es.array.for-each","core-js/modules/es.array.iterator","core-js/modules/es.array.join","core-js/modules/es.array.map","core-js/modules/es.date.to-string","core-js/modules/es.object.entries","core-js/modules/es.object.to-string","core-js/modules/es.promise","core-js/modules/es.regexp.exec","core-js/modules/es.regexp.to-string","core-js/modules/es.string.iterator","core-js/modules/es.string.split","core-js/modules/web.dom-collections.for-each","core-js/modules/web.dom-collections.iterator","@babel/runtime/helpers/typeof","@babel/runtime/helpers/toConsumableArray","path","load-bmfont","@jimp/utils"]
//# sourceMappingURL=index.js.map