...
__DEFINE__(1679975016684, function(require, module, exports) {
/**
 * 提供 npm 包引用的入口
 */
var COS = require('./sdk/cos');
module.exports = COS;
}, function(modId) {var map = {"./sdk/cos":1679975016685}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016685, function(require, module, exports) {
...
}, function(modId) { var map = {"./util":1679975016686,"./event":1679975016687,"./task":1679975016688,"./base":1679975016690,"./advance":1679975016693,"../package.json":1679975016691}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016686, function(require, module, exports) {
...
__DEFINE__(1679975016687, function(require, module, exports) {
...
__DEFINE__(1679975016688, function(require, module, exports) {
...
}, function(modId) { var map = {"./session":1679975016689,"./util":1679975016686}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016689, function(require, module, exports) {
var util = require('./util');
// 按照文件特征值，缓存 UploadId
...
}, function(modId) { var map = {"./util":1679975016686}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016690, function(require, module, exports) {
var pkg = require('../package.json');
...
}, function(modId) { var map = {"../package.json":1679975016691,"./util":1679975016686,"./select-stream":1679975016692}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016691, function(require, module, exports) {
module.exports = {
...
__DEFINE__(1679975016692, function(require, module, exports) {
...
}, function(modId) { var map = {"util":1679975016686,"./util":1679975016686}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016693, function(require, module, exports) {
var session = require('./session');
var fs = require('fs');
...
}, function(modId) { var map = {"./session":1679975016689,"./async":1679975016694,"./event":1679975016687,"./util":1679975016686}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679975016694, function(require, module, exports) {
...
return __REQUIRE__(1679975016684);
})()
